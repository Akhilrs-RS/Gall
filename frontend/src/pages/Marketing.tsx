...
const Marketing: React.FC<MarketingProps> = ({ navigateToContact }) => {
  return (
    <>
      ...
      <section id="marketing" className="w-full bg-[#07080a] pt-32 md:pt-40 pb-20 flex flex-col justify-center min-h-[calc(100vh-6rem)] lg:min-h-0">
      ...
      <section className="w-full bg-[#07080a] pt-24 md:pt-32 lg:pt-40 pb-0 border-t border-slate-900/60 flex flex-col items-center">
      ...
      <section className="w-full bg-[#07080a] pt-16 md:pt-20 lg:pt-24 pb-24 md:pb-32 lg:pb-40 min-h-screen flex items-center">
