...
import contactImg from './assets/c1.png'

function App() {
  const [view, setView] = useState<'about' | 'industry' | 'contact'>('about')
      ...
      <header className="w-full bg-[#07080a]/90 backdrop-blur-md border-b border-slate-900 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 md:px-12 h-24 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-10">
            ...
            <a href="#works" className="text-[15px] font-medium text-slate-300 hover:text-white transition-colors duration-200">
              Works
            </a>
      ...
      <main className="w-full flex flex-col items-center">
        ...
        {view === 'industry' && (
          <>
            ...
            {/* Industry Page 3: Additional Sector Cards Grid */}
            <section id="industry-page-3" className="w-full bg-[#07080a] pb-24 md:pb-32 border-t border-slate-900/60 pt-24 md:pt-32">
              <div className="max-w-7xl mx-auto px-6 md:px-12">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10">
            ...
            <div className="col-span-12 md:col-span-6 grid grid-cols-3 gap-6 md:gap-8">
              ...
              <div className="space-y-5">
                ...
                <ul className="space-y-3.5">
                  ...
                  <li><a href="#works" className="text-slate-400 text-[14px] hover:text-white transition-colors duration-200">Our Work</a></li>
